...
class CSRF
{
    ...
    public function generateToken(): string
    {
        ...
        $this->session->setArray($this->sessionKey, $token); // J'enregistre mon token dans un tableau de session 
        $this->limitToken();
    ...
    // Permet de récuperer le token consommer dans le tableau de token 
